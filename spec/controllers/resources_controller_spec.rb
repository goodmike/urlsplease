...
describe ResourcesController do
  ...
  describe "GET new" do
    ...
    describe "when authorizing user and request are present" do
      ...
      it "looks up user" do
        User.should_receive(:where).with(:nickname => "Uwe") { [mock_user] }
        get :new, :user_id => "Uwe", :request_id => "2"
      end
      ...
      it "assigns user to the resource" do
  ...
  describe "GET edit" do
    ...
    describe "when authorizing user and request params are present" do
      ...
      it "looks up user" do
        User.should_receive(:where).with(:nickname => "Uwe") { [mock_user] }
        get :edit, :user_id => "Uwe", :request_id => "2", :id => "3"
      end
  ...
  describe "POST create" do
    ...
    describe "when authorizing user and request present" do
      ...
      it "looks up user" do
        User.should_receive(:where).with(:nickname => "Uwe") { [mock_user] }
        post :create, :user_id => "Uwe", :request_id => "2", :resource => {'these' => 'params'}
      end
    ...
    it "returns a 404 error when no authorizing request is present" do
      post :create, :user_id => "Uwe", :resource => {'these' => 'params'}
      response.code.should ==("404")
    end
  end
  ...
  describe "PUT update" do
    ...
    it "should render update template with 501 response code" do
      put :update, :user_id => "Uwe", :request_id => "2", :id => "3"
  ...
  describe "DELETE destroy" do
    ...
    it "should not be accessible by GET" do
      get :destroy, :user_id => "Uwe", :request_id => "2", :id => "3"
    ...
    describe "when authorizing user param is present" do
      ...
      it "looks up user" do
        User.should_receive(:where).with(:nickname => "Uwe") { [mock_user] }
        delete :destroy, :user_id => "Uwe", :request_id => "2", :id => "3"
      end
    ...
    it "returns a 404 error when no authorizing request is present" do
      delete :destroy, :user_id => "Uwe", :id => "3"
      response.code.should ==("404")
    end
  end
